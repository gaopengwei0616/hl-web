...
//分页对象
function Page(){
    var pageIndexValue = GetQueryString("pageNum");
    if(pageIndexValue==''||pageIndexValue==null||pageIndexValue==undefined){
        pageIndexValue='1';
    }
    this.config = {elemId:'#page',pageIndex:pageIndexValue,total:'0',pageNum:'7',pageSize:'10'};//默认参数
